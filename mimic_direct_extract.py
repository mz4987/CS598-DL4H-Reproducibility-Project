...
if __name__ == '__main__':
    ...
    ap.add_argument('--out_path', type=str, default= '/Users/{}/Desktop/UIUC_MCS/CS598DLH/MIMIC_Extract/data/1000'.format(os.environ['USER']),
                    help='Enter the path you want the output')
    ap.add_argument('--resource_path',
        type=str,
        default=os.path.expandvars("/Users/mengxuan/Desktop/UIUC_MCS/CS598DLH/MIMIC_Extract/resources/"))
    ap.add_argument('--queries_path',
        type=str,
        default=os.path.expandvars("/Users/mengxuan/Desktop/UIUC_MCS/CS598DLH/MIMIC_Extract/SQL_Queries/"))
